...
class RestauranteAdapter(private val listaRestaurante: ArrayList<Restaurante>, val listener: onRestClickListener): RecyclerView.Adapter<RestauranteAdapter.RestViewHolder>() {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): RestauranteAdapter.RestViewHolder {
    ...
    override fun onBindViewHolder(holder: RestauranteAdapter.RestViewHolder, position: Int) {
